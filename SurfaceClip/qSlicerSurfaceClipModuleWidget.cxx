...
#include "ui_qSlicerSurfaceClipModule.h"
...
class qSlicerSurfaceClipModuleWidgetPrivate: public Ui_qSlicerSurfaceClipModule
{
	Q_DECLARE_PUBLIC(qSlicerSurfaceClipModuleWidget);

public:
	qSlicerSurfaceClipModuleWidgetPrivate(qSlicerSurfaceClipModuleWidget& object);

protected:
	qSlicerSurfaceClipModuleWidget* const q_ptr;
};

//	qSlicerSurfaceClipModuleWidgetPrivate methods

qSlicerSurfaceClipModuleWidgetPrivate::
	qSlicerSurfaceClipModuleWidgetPrivate(qSlicerSurfaceClipModuleWidget& object)
	 : q_ptr(&object)
{
}

//	qSlicerSurfaceClipModuleWidget methods

qSlicerSurfaceClipModuleWidget::qSlicerSurfaceClipModuleWidget(QWidget* _parent)
  : Superclass( _parent )
  , d_ptr( new qSlicerSurfaceClipModuleWidgetPrivate(*this) )
{
...
qSlicerSurfaceClipModuleWidget::~qSlicerSurfaceClipModuleWidget()
{
...
void qSlicerSurfaceClipModuleWidget::createPlane()
{
	Q_D(qSlicerSurfaceClipModuleWidget);
...
void qSlicerSurfaceClipModuleWidget::appendPlane()
{
...
void qSlicerSurfaceClipModuleWidget::removePlane()
{
	Q_D(qSlicerSurfaceClipModuleWidget);
...
void qSlicerSurfaceClipModuleWidget::hideSurface()
{
  Q_D(qSlicerSurfaceClipModuleWidget);

  this->renderWindow->Render();
  this->iren->Initialize();
  if (d->hideButton->text() == tr("Hide the Surface")) {
    for (int i = 0; i < this->numOfPlanes; i++) {
    ...
    d->appendButton->setEnabled(false);
    d->removeButton->setEnabled(false);
    d->hideButton->setText(tr("Show the Surface"));
    d->deleteButton->setEnabled(false);
    d->clipButton->setEnabled(false);
    d->depthButton->setEnabled(false);
  } else {
    ...
    d->removeButton->setEnabled(true);
    d->hideButton->setText(tr("Hide the Surface"));
    d->deleteButton->setEnabled(true);
    d->clipButton->setEnabled(!this->isClipped);
    d->depthButton->setEnabled(true);
  }
...
void qSlicerSurfaceClipModuleWidget::deleteSurface()
{
	Q_D(qSlicerSurfaceClipModuleWidget);
...
void qSlicerSurfaceClipModuleWidget::setDepth()
{
  Q_D(qSlicerSurfaceClipModuleWidget);
...
void qSlicerSurfaceClipModuleWidget::clip()
{
	Q_D(qSlicerSurfaceClipModuleWidget);
...
void qSlicerSurfaceClipModuleWidget::setup()
{
	Q_D(qSlicerSurfaceClipModuleWidget);
	d->setupUi(this);
...
double* qSlicerSurfaceClipModuleWidget::getPoint3(int i)
{
...
double* qSlicerSurfaceClipModuleWidget::makePoint2(int i)
{
	double *oP1 = new double[3];
	double *oP2 = new double[3];
...
double* qSlicerSurfaceClipModuleWidget::lengthen(int i)
{
...
double qSlicerSurfaceClipModuleWidget::dotProduct(int i)
{
	return this->dotProduct(i, i - 1);
}

double qSlicerSurfaceClipModuleWidget::dotProduct(int i, int j)
{
	double *oP2 = new double[3];
	vtkMath::Subtract(
...
bool qSlicerSurfaceClipModuleWidget::isInter(int i)
{
	if (i == 2) {
		return false;
	}
...
void qSlicerSurfaceClipModuleWidget::clearBodyList()
{
...
vtkSmartPointer<vtkImplicitBoolean> qSlicerSurfaceClipModuleWidget::makeAngle(int i)
{
...
vtkSmartPointer<vtkImplicitBoolean> qSlicerSurfaceClipModuleWidget::makeAngle(int i, int j)
{
  vtkSmartPointer<vtkImplicitBoolean> angle = 
    vtkSmartPointer<vtkImplicitBoolean>::New();
  angle->SetOperationTypeToDifference();
...
vtkSmartPointer<vtkImplicitBoolean> qSlicerSurfaceClipModuleWidget::makeBody(int i)
{
...
vtkSmartPointer<vtkImplicitBoolean> qSlicerSurfaceClipModuleWidget::makeBody(int i, int j)
{
...
vtkSmartPointer<vtkImplicitBoolean> qSlicerSurfaceClipModuleWidget::
